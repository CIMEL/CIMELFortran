...
!      use mod_os
      ...
      real R(KRpar),RATIO(KR1par),RRATN
!tl      real*4 R(KRpar),RATIO(KR1par),RRATN
...
c	WRITE(250,*)'CXXA,NDP',NDP
	...
	write(1011,*)'file=',TRIM(full_name)
...
!cl        WRITE(*,11) ANGLE1(:KM1)
					...
					WRITE(1011,*) 'READ matrix U',NEL(KEL)
...
!cl        WRITE(*,*) RIMMIN, RIMMAX,' RIMMIN,RIMMAX'        
						WRITE(21,*) KRE, KIM,
     1						' number of intervals for opt. const'
!cl        WRITE(*,*) KRE, KIM,' KRE, KIM'
					endif ! key_org=1
...
!cl      WRITE(*,*) rmin,rmax,RATIO(iratn),' rmin,rmax,ratio'
				...
				ENDIF
				WRITE(1011,*) 'READ matrix U',NEL(0)
				READ(11,*) RREMIN, RREMAX
!cl      WRITE(*,*) RREMIN, RREMAX,' RREMIN,RREMAX'  
				READ(11,*) RIMMIN, RIMMAX
!cl      WRITE(*,*) RIMMIN, RIMMAX,' RIMMIN,RIMMAX'
...
!cl       write(*,*) 'U34 before intrpl orgnl:',U34(1,j,1,1,1)
					ENDDO ! J
				endif
			ENDIF ! keyEL
